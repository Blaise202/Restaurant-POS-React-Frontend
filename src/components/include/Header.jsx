...
export function Header() {
  return (
    <div className="flex justify-between items-center py-3 px-8 bg-[#1a1a1a]">
      {/* logo */}
      <div className="flex items-center gap-2">
        ...
        />
        <h1 className="text-lg font-semibold text-[#f5f5f5]">A_Z Restaurant</h1>
      </div>
      {/* search */}
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-3 cursor-pointer ">
          ...
          <div className="flex flex-col items-start">
            <h1 className="text-md text-[#f5f5f5] font-semibold ">Blaise</h1>
